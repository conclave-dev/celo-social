    ...
    return (
      <React.Fragment>
        <Dropdown
          ...
          toggle={this.toggle}
          className="notification-list list-inline-item d-none  d-md-inline-block mr-1"
          tag="li"
        >
          <DropdownToggle
            ...
            tag="a"
          >
            <img alt="Veltrix" src={usFlag} className="mr-2" height="12" /> English{' '}
            <span className="mdi mdi-chevron-down"></span>
          </DropdownToggle>
          <DropdownMenu className="language-switch" right>
            <DropdownItem tag="a" href="#">
              <img alt="Veltrix" src={germanyFlag} height="16" />
              <span> German </span>
            </DropdownItem>
            <DropdownItem tag="a" href="#">
              <img alt="Veltrix" src={italyFlag} height="16" />
              <span> Italian </span>
            </DropdownItem>
            <DropdownItem tag="a" href="#">
              <img alt="Veltrix" src={frenchFlag} height="16" />
              <span> French </span>
            </DropdownItem>
            <DropdownItem tag="a" href="#">
              <img alt="Veltrix" src={spainFlag} height="16" />
              <span> Spanish </span>
            </DropdownItem>
            <DropdownItem tag="a" href="#">
              <img alt="Veltrix" src={russiaFlag} height="16" />
              <span> Russian </span>
            </DropdownItem>
          </DropdownMenu>
        </Dropdown>
